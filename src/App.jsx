...
function App() {
  ...
  }, [editingCorners, originalImage, dragState]); // Include dragState to redraw during drag
  ...
  const drawEditableCorners = (canvas, image, corners) => {
    const ctx = canvas.getContext("2d");
    ...
    <div className="p-5 font-sans max-w-4xl mx-auto">
      ...
      {editingCorners && originalImage && (
        <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 p-2">
          <div className="bg-white rounded-lg p-4 w-full max-w-full max-h-[95vh] overflow-auto">
            <h2 className="text-xl font-semibold mb-3 text-center">Adjust Points</h2>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-3">
              <p className="text-blue-800 font-medium mb-2 text-sm">Instructions:</p>
            ...
            <div className="mb-3 bg-gray-50 p-2 rounded-lg">
              <canvas 
                ...
                className="border-2 border-gray-400 rounded cursor-pointer max-w-full h-auto mx-auto block shadow-lg touch-none select-none"
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
              ...
              <div className="flex gap-3 justify-center">
                <button 
                  ...
                  className="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg font-medium transition-colors text-sm"
                >
                  Cancel
                </button>
                <button 
                  onClick={applyEditedCorners}
                  className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-medium transition-colors text-sm"
                >
                  ✅ Apply
                </button>
              </div>
